...
names(test_melt)[3]<-"featurename"
names(test_melt)[4]<-"featurevalue"
...
names(train_melt)[3]<-"featurename"
names(train_melt)[4]<-"featurevalue"
...
tidy_data <- NULL
tidy_data <- ddply(all_melt, c("subject","activity", "featurename"), summarise,
               mean = mean(featurevalue));
